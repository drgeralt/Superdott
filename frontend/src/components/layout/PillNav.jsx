...
const PillNav = ({
    ...
    const currentActive = activeHref || location.pathname;
    useEffect(() => {
        const layout = () => {
    ...
    return (
        <div className="pill-nav-container relative z-50">
                        ...
                        {items.map((item, i) => (
                            <li key={item.href || `item-${i}`} role="none">
                                ...
                                >
                                    ...
                                    />
                                    <span className="label-stack font-headline font-bold text-sm">
