                    ...
                    <div className="space-y-2 animate-pulse">
                        {[1, 2, 3].map(i => (
                            <div key={i} className="flex items-center gap-3 p-3 rounded-xl bg-surface-container-high">
                                <div className="w-10 h-10 rounded-full bg-outline-variant/30"></div>
                ...
                <div className="space-y-2">
                    {students.map(student => (
                        ...
                        >
                            ...
                            <div>
                                <p className={`text-sm font-bold font-headline ${selectedStudent?.id === student.id ? 'text-primary-navy' : 'text-on-surface'}`}>
                                    {student.full_name}
                                </p>
